...
class Configuration:
    ...
    def __init__(self):
        ...
        self.preprocessed_dir = "/isipd/projects/p_planetdw/data/dw_detection/PlanetScope/training_data/training_data_within_aoi"               # if set to None, it will use the most recent preprocessing data
        ...
        self.evaluation_path = '/isipd/projects/p_planetdw/data/dw_detection/PlanetScope/evaluation'
        self.evaluate_model_path = '/isipd/projects/p_planetdw/data/dw_detection/PlanetScope/models/dem.h5'
...
# =============================================================================
        ...
        self.prediction_output_dir = '/isipd/projects/p_planetdw/data/dw_detection/PlanetScope/results/2019' #'/isipd/projects/p_planetdw/data/dw_detection/PlanetScope/results/20241021-0711_dem_only/'        # set dynamically at prediction time

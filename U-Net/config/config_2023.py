...
class Configuration:
    ...
    def __init__(self):
        ...
        # --------- RUN NAME ---------
        self.run_name = '2023'                     # custom name for this run, eg resampled_x3, alpha60, final_run_final_final
        # ---------- PATHS -----------
        ...
        self.to_predict_dir = '/isipd/projects/p_planetdw/data/dw_detection/PlanetScope/images/2023_dem' #'/nfs/Planet/PlanetScope/Mosaics/South_Asia/2021'
        ...
        self.postprocessing_dir = '/isipd/projects/p_planetdw/data/dw_detection/PlanetScope/results/2023'             # if set to None, it will run postprocessing on the last predictions
...
# =============================================================================
        ...
        self.prediction_output_dir = '/isipd/projects/p_planetdw/data/dw_detection/PlanetScope/results/2023' #'/isipd/projects/p_planetdw/data/dw_detection/PlanetScope/results/20241021-0711_dem_only/'        # set dynamically at prediction time
